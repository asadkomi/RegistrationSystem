...
public class MailConfig {
    ...
    private static final String APPLICATION_NAME = "Registration System";
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        InputStream inputStream = MailConfig.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (inputStream == null) {
        ...
        Credential credential = new AuthorizationCodeInstalledApp(googleAuthorizationCodeFlow, localServerReceiver).authorize("user");
         return credential;
    }
